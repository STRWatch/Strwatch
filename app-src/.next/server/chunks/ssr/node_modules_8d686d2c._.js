...
2) With environment variables e.g.
   ...
   NEXT_PUBLIC_CLERK_IS_SATELLITE='true'`,au=()=>av("getAuth",void 0,ar.middlewareFileReference),av=(a="auth",b,c="middleware")=>`Clerk: ${a}() was called but Clerk can't detect usage of clerkMiddleware(). Please ensure the following:
...
`,aw="Clerk: Unable to verify request, this usually means the Clerk middleware did not run. Ensure Clerk's middleware is properly integrated and matches the current route. For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware. (code=auth_signature_invalid)",ax="Clerk: Unable to decrypt request data, this usually means the encryption key is invalid. Ensure the encryption key is properly set. For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)",ay=`Clerk: Unable to decrypt request data.

Refresh the page if your .env file was just updated. If the issue persists, ensure the encryption key is valid and properly set.

For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`;function az(a,b){if(!(0,l.detectClerkMiddleware)(a))throw Error(b)}function aA(a,b,c){if(!c||aq(a,b).toString()!==c)throw Error(aw)}a.s(["authAuthHeaderMissing",()=>av,"authSignatureInvalid",()=>aw,"encryptionKeyInvalid",()=>ax,"encryptionKeyInvalidDev",()=>ay,"encryptionKeyMissing",()=>"Clerk: Missing `CLERK_ENCRYPTION_KEY`. Required for propagating `secretKey` middleware option. See docs: https://clerk.com/docs/references/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_missing)","getAuthAuthHeaderMissing",()=>au,"missingDomainAndProxy",()=>as,"missingSignInUrlInDev",()=>at],75077),a.i(83693);let aB="clerk_keyless_dummy_key";function aC(a){if(!a)return{};let b=(0,q.n)()?k.ENCRYPTION_KEY||k.SECRET_KEY:k.ENCRYPTION_KEY||k.SECRET_KEY||aB;try{return aE(a,b)}catch{if(y.canUseKeyless)try{return aE(a,aB)}catch{aD()}aD()}}function aD(){if((0,q.n)())throw Error(ax);throw Error(ay)}function aE(a,b){return JSON.parse(an.decrypt(a,b).toString(F))}a.s(["assertAuthStatus",()=>az,"assertTokenSignature",()=>aA,"decryptClerkRequestData",()=>aC],54772);let aF=a=>({authStatus:(0,l.getAuthKeyFromRequest)(a,"AuthStatus"),authToken:(0,l.getAuthKeyFromRequest)(a,"AuthToken"),authMessage:(0,l.getAuthKeyFromRequest)(a,"AuthMessage"),authReason:(0,l.getAuthKeyFromRequest)(a,"AuthReason"),authSignature:(0,l.getAuthKeyFromRequest)(a,"AuthSignature")}),aG=(a,b,c=!0)=>{let e=aC((0,l.getHeader)(a,d.constants.Headers.ClerkRequestData));return{secretKey:(null==b?void 0:b.secretKey)||e.secretKey||k.SECRET_KEY,publishableKey:e.publishableKey||k.PUBLISHABLE_KEY,apiUrl:k.API_URL,apiVersion:k.API_VERSION,authStatus:(0,l.getAuthKeyFromRequest)(a,"AuthStatus"),authMessage:(0,l.getAuthKeyFromRequest)(a,"AuthMessage"),authReason:(0,l.getAuthKeyFromRequest)(a,"AuthReason"),treatPendingAsSignedOut:c}},aH=(a,{treatPendingAsSignedOut:b=!0,...c}={})=>{var e,f;let{authStatus:g,authMessage:h,authReason:i,authToken:k,authSignature:l}=aF(a);null==(e=c.logger)||e.debug("headers",{authStatus:g,authMessage:h,authReason:i});let m=aG(a,c,b);if(!(0,d.isTokenTypeAccepted)(d.TokenType.SessionToken,c.acceptsToken||d.TokenType.SessionToken))return(0,d.signedOutAuthObject)(m);if(g&&g===d.AuthStatus.SignedIn){aA(k,m.secretKey,l);let a=j(k);return null==(f=c.logger)||f.debug("jwt",a.raw),(0,d.getAuthObjectFromJwt)(a,m)}return(0,d.signedOutAuthObject)(m)},aI=(a,b={})=>{var c,e;let{authStatus:f,authMessage:g,authReason:h}=aF(a);null==(c=b.logger)||c.debug("headers",{authStatus:f,authMessage:g,authReason:h});let i=aC((0,l.getHeader)(a,d.constants.Headers.ClerkRequestData)),j=null==(e=(0,l.getHeader)(a,d.constants.Headers.Authorization))?void 0:e.replace("Bearer ",""),k=b.acceptsToken||d.TokenType.SessionToken,m=aG(a,b),n=aJ(j,i.machineAuthObject,k,m);return n||(j&&(0,d.isMachineToken)(j)?(0,d.signedOutAuthObject)(m):j&&Array.isArray(k)&&!k.includes(d.TokenType.SessionToken)?(0,d.invalidTokenAuthObject)():aH(a,b))},aJ=(a,b,c,e)=>{let f=a&&(0,d.isMachineToken)(a),g=c===d.TokenType.SessionToken||Array.isArray(c)&&1===c.length&&c[0]===d.TokenType.SessionToken;if(f&&b&&!g){let f=(0,d.getAuthObjectForAcceptedToken)({authObject:{...b,debug:()=>e},acceptsToken:c});return{...f,getToken:()=>f.isAuthenticated?Promise.resolve(a):Promise.resolve(null),has:()=>!1}}return null};a.s(["getAuthDataFromRequest",()=>aI,"getSessionAuthDataFromRequest",()=>aH],95374)},24202,a=>{"use strict";var b,c,d=a.i(43405);let e=Symbol.for("clerk_use_cache_error");class f extends(c=Error,b=e,c){constructor(a,c){super(a),this.originalError=c,this[b]=!0,this.name="ClerkUseCacheError"}}let g=a=>a instanceof Error&&e in a,h=/inside\s+["']use cache["']|["']use cache["'].*(?:headers|cookies)|(?:headers|cookies).*["']use cache["']/i,i=/cache scope/i,j=/dynamic data source/i,k=/Route .*? needs to bail out of prerendering at this point because it used .*?./,l=a=>{if(!(a instanceof Error)||!("message"in a))return!1;let{message:b}=a,c=b.toLowerCase();return k.test(b)||c.includes("dynamic server usage")||c.includes("this page needs to bail out of prerendering")||c.includes("during prerendering")},m=a=>{if(!(a instanceof Error))return!1;let{message:b}=a;return!!(h.test(b)||i.test(b)&&j.test(b))},n=`Clerk: auth() and currentUser() cannot be called inside a "use cache" function. These functions access \`headers()\` internally, which is a dynamic API not allowed in cached contexts.
...
To fix this, call auth() outside the cached function and pass the values you need as arguments:
  ...
  }`;async function o(){try{let{headers:b}=await a.A(23804),c=await b();return new d.NextRequest("https://placeholder.com",{headers:c})}catch(a){if(a&&l(a))throw a;if(a&&m(a))throw new f(`${n}
